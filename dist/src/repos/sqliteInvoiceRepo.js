    ...
    SqliteInvoiceRepo.prototype.invoiceOfID = function (invoiceID) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = 'SELECT id, creation_date, iban, ref_job FROM Invoice WHERE id=?';
                        return [4 /*yield*/, this._db.get(query, [invoiceID.toString()])];
                    case 1:
                        row = _a.sent();
                        return [2 /*return*/, new invoice_1.Invoice(new invoiceID_1.InvoiceID(row.id), new jobID_1.JobID(row.ref_job), row.iban, row.creation_date)];
                }
            });
        });
    };
